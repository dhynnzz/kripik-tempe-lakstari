    ...
    try {
      ...
      if (res && res.data) {
        ...
        if (res.stats) {
          ...
          const activeCount = items.filter((c: CustomerItem) => c.status_pelanggan === 'Aktif').length;
          setStats({
            total: items.length,
            active: activeCount,
          ...
          <>
            ...
            <div className="cm-desktop-table-wrap">
              <table className="cm-table">
                ...
                <tbody>
                  {customers.map((c) => {
                    const isAktif = c.status_pelanggan === 'Aktif';
                    return (
                      <tr key={c.id_pelanggan} className="cm-table-row">
                        ...
                        <td>
                          <div className="cm-user-cell">
                            <div
                              className="cm-avatar"
                              style={{ backgroundColor: getAvatarBg(c.nama_pelanggan) }}
                            >
                        ...
                        <td>
                          <div className="cm-actions-cell">
                            ...
                            <select
                              className={`cm-select-status ${isAktif ? 'select-aktif' : 'select-blacklist'}`}
                ...
                return (
                  <div key={c.id_pelanggan} className="cm-card-item">
                    ...
                    <div className="cm-card-body">
                      ...
                      <div className="cm-mobile-info-row">
                        ...
                        <span className="cm-order-badge">
                          ...
                          {c.transaksi_count || 0} Kali Belanja
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="cm-card-actions">
                      ...
                      <select
                        className={`cm-select-status-mobile ${isAktif ? 'select-aktif' : 'select-blacklist'}`}
                        value={c.status_pelanggan}
                        onChange={(e) => handleStatusChange(c.id_pelanggan, c.nama_pelanggan, e.target.value)}
                      >
                        <option value="Aktif">Aktif</option>
            ...
            <div className="cm-modal-body">
              ...
              <div className="cm-modal-info-grid">
                ...
                <div className="cm-modal-info-item">
                  ...
                  <div className="cm-m-val-row">
                    <span className={`cm-status-pill ${selectedCustomer.status_pelanggan === 'Aktif' ? 'aktif' : 'blacklist'}`}>
                      {selectedCustomer.status_pelanggan}
                    </span>
                    <button
                      type="button"
                      ...
                      onClick={() =>
                        handleStatusChange(
                          ...
                          selectedCustomer.status_pelanggan === 'Aktif' ? 'Blacklist' : 'Aktif'
                        )
                      }
                    >
                      Ubah ke {selectedCustomer.status_pelanggan === 'Aktif' ? 'Blacklist' : 'Aktif'}
                    </button>
                  </div>
                </div>
